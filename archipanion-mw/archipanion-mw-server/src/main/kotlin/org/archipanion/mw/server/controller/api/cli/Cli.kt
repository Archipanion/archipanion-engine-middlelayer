package org.archipanion.mw.server.controller.api.cli

import com.github.ajalt.clikt.core.*
import org.archipanion.mw.server.controller.api.cli.commands.ConfigCommand
...
class Cli(private  val config: RootConfig) {
     ...
     */
    inner class MainCommand : NoOpCliktCommand(name = "arc", help = "The base command for all CLI commands.") {
        init {
            subcommands(
                ConfigCommand(this@Cli.config),
                StopCommand()
            )
        }
    }
