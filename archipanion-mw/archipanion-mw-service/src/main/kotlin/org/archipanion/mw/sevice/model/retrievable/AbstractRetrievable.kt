...
import org.archipanion.mw.sevice.model.retrievable.attributes.MergingRetrievableAttribute
import org.archipanion.mw.sevice.model.retrievable.attributes.RetrievableAttribute
import java.util.*

abstract class AbstractRetrievable(override val id: UUID, override val type: String?, override val transient: Boolean) :
    Retrievable {
